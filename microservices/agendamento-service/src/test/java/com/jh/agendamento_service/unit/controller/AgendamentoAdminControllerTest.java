...
public class AgendamentoAdminControllerTest {
	...
	@Test
	@WithMockUser
	public void deveRetornar401QuandoUsuarioAutenticadoNaoForAdminAoCriarAgendamento() throws JacksonException, Exception {		
		mockMvc.perform(post(BASE_URL)
				.contentType(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(agendamentoAdminRequest)))
	...
	public void deveRetornar200EOAgendamentoAoGetAgendamentoPorIdComSucesso() throws JacksonException, Exception {
		...
		mockMvc.perform(get(BASE_URL+"/"+AGENDAMENTO_ID))
			.andExpect(status().isOk())
	...
	@Test
	@WithMockUser(authorities = ADMIN)
	public void deveRetornar404QuandoAgendamentoNaoForEncontradoAoGetAgendamentoPorId() throws JacksonException, Exception {
		NaoEncontradoException ex = new NaoEncontradoException("procedimento");
	...
	public void deveRetornar200AoAtualizarAgendamentoComSucesso() throws JacksonException, Exception {
		mockMvc.perform(put(BASE_URL+"/"+AGENDAMENTO_ID)
				.contentType(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(agendamentoAdminRequest)))
		.andExpect(status().isOk());
	...
	@Test
	@WithMockUser(authorities = ADMIN)
	public void deveRetornar409QuandoAgendamentoResultarEmConflitoDeHorarioAoAtualizarAgendamento() throws JacksonException, Exception {
		ConflitoDeHorarioException ex = new ConflitoDeHorarioException();
	...
	@Test
	@WithMockUser
	public void deveRetornar401QuandoUsuarioAutenticadoNaoForAdminAoAtualizarAgendamento() throws JacksonException, Exception {		
		mockMvc.perform(put(BASE_URL+"/"+AGENDAMENTO_ID)
				.contentType(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(agendamentoAdminRequest)))
		.andExpect(status().isForbidden());
	...
	public void deveRetornar200AoAlterarStatusDoAgendamentoComSucesso() throws JacksonException, Exception {
		mockMvc.perform(patch(BASE_URL+"/"+AGENDAMENTO_ID+"/status")
				.contentType(MediaType.APPLICATION_JSON)
	...
	@Test
	@WithMockUser(authorities = ADMIN)
	public void deveRetornar400QuandoRequestForIncorretoAoAlterarStatusDoAgendamento() throws JacksonException, Exception {
		mockMvc.perform(patch(BASE_URL+"/"+AGENDAMENTO_ID+"/status")
				.contentType(MediaType.APPLICATION_JSON)
	...
	@Test
	@WithMockUser(authorities = ADMIN)
	public void deveRetornar404QuandoProcedimentoNaoForEncontradoAoAlterarStatusDoAgendamento() throws JacksonException, Exception {
		NaoEncontradoException ex = new NaoEncontradoException("procedimento");
	...
	@Test
	@WithMockUser
	public void deveRetornar401QuandoUsuarioAutenticadoNaoForAdminAoAlterarStatusDoAgendamento() throws JacksonException, Exception {		
		mockMvc.perform(patch(BASE_URL+"/"+AGENDAMENTO_ID+"/status")
				.contentType(MediaType.APPLICATION_JSON)
				.content(objectMapper.writeValueAsString(agendamentoAdminRequest)))
		.andExpect(status().isForbidden());
